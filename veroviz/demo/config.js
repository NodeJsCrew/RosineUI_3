...
function setConfigs() {
    viewer.camera.flyTo({
        destination: Cesium.Rectangle.fromDegrees(103.996657, 30.624820, 104.133015, 30.708192) 
    });
    viewer.clock.currentTime = Cesium.JulianDate.addSeconds('2022-04-20T08:00:00Z', 0, new Cesium.JulianDate());
    allIDs = [
